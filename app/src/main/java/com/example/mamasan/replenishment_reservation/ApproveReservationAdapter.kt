...
class ApproveReservationAdapter(val replenishmentFood: ArrayList<ReplenishmentFood>,  private val onDetailClicklistener: OnDetailClicklistener):
    RecyclerView.Adapter<ApproveReservationAdapter.ViewHolder>(){
...
//        holder.check_bttn.isVisible = true
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ApproveReservationAdapter.ViewHolder {
